...
<?php
    $pageTitle = __('addNewEstoqueSaida'); //set dynamic page title
?>
@extends($layout)
            ...
            <div class="row ">
                <div class="col-md-9 comp-grid " >
                    <div  class="card card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form id="estoquesaidas-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="{{ route('estoquesaidas.store') }}" method="post">
                            @csrf
                            <div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-motivo-holder" class=" ">
                                                <input id="ctrl-motivo" data-field="motivo"  value="<?php echo get_value('motivo', "NULL") ?>" type="text" placeholder="{{ __('enterMotivo') }}"  name="motivo"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
