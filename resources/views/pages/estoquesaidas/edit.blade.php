...
<?php
    $pageTitle = __('editEstoqueSaida'); //set dynamic page title
?>
@extends($layout)
            ...
            <div class="row ">
                <div class="col-md-9 comp-grid " >
                    <div  class="card card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("estoquesaidas/edit/$rec_id"); ?>" method="post">
                        <!--[form-content-start]-->
                        @csrf
                        <div>
                            ...
                            <div class="form-group ">
                                <div class="row">
                                    <div class="col-sm-4">
                                        <label class="control-label" for="motivo">{{ __('motivo') }} </label>
                                    </div>
                                    <div class="col-sm-8">
                                        <div id="ctrl-motivo-holder" class=" ">
                                            <input id="ctrl-motivo" data-field="motivo"  value="<?php  echo $data['motivo']; ?>" type="text" placeholder="{{ __('enterMotivo') }}"  name="motivo"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
