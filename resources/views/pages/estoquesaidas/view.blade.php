...
<?php
    ...
    $pageTitle = __('estoqueSaidaDetails'); //set dynamic page title
?>
@extends($layout)
        ...
        <div class="container">
            <div class="row ">
                            ...
                            <div class="page-data">
                                ...
                                <div class="col-12">
                                    <div class="bg-light mb-1 card-1 p-2 border rounded">
                                        <div class="row align-items-center">
                                            <div class="col">
                                                <small class="text-muted">{{ __('motivo') }}</small>
                                                <div class="fw-bold">
                                ...
                                <div class="col-12">
                                    <div class="bg-light mb-1 card-1 p-2 border rounded">
                                        <div class="row align-items-center">
                                            <div class="col">
                                                <small class="text-muted">{{ __('dataSaida') }}</small>
                                                <div class="fw-bold">
                                                    <?php echo  $data['data_saida'] ; ?>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="d-flex align-items-center gap-2">
                    ...
                    <?php if($can_edit){ ?>
                    <a class="btn btn-sm btn-success has-tooltip "   title="{{ __('edit') }}" href="<?php print_link("estoquesaidas/edit/$rec_id"); ?>" >
                    <i class="material-icons">edit</i> {{ __('edit') }}
                </a>
                <?php } ?>
                <?php if($can_delete){ ?>
                <a class="btn btn-sm btn-danger has-tooltip record-delete-btn" data-prompt-msg="{{ __('promptDeleteRecord') }}" data-display-style="modal" title="{{ __('delete') }}" href="<?php print_link("estoquesaidas/delete/$rec_id?redirect=estoquesaidas"); ?>" >
