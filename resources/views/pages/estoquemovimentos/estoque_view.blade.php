...
<?php
    ...
    $can_add = $user->canAccess("estoquemovimentos/add");
    $can_edit = $user->canAccess("estoquemovimentos/edit");
    $can_view = $user->canAccess("estoquemovimentos/view");
    $can_delete = $user->canAccess("estoquemovimentos/delete");
    $field_name = request()->segment(3);
    $field_value = request()->segment(4);
    $total_records = $records->total();
    $limit = $records->perPage();
    $record_count = count($records);
    $pageTitle = __('estoqueMovimentos'); //set dynamic page title
?>
@extends($layout)
            ...
            <div class="row justify-content-between align-items-center gap-3">
                <div class="col  " >
                    <div class=" h5 font-weight-bold text-primary" >
                        {{ __('estoqueMovimentos') }}
                    </div>
                </div>
                <div class="col-auto  " >
                    <?php if($can_add){ ?>
                    <a  class="btn btn-primary btn-block" href="<?php print_link("estoquemovimentos/add", true) ?>" >
                    <i class="material-icons">add</i>                               
                    {{ __('addNewEstoqueMovimento') }} 
                </a>
                <?php } ?>
            </div>
            <div class="col-md-3  " >
        ...
        <div class="row ">
            <div class="col comp-grid " >
                <div  class=" page-content" >
                    <div id="estoquemovimentos-estoque_view-records">
                        <div id="page-main-content" class="table-responsive">
                            <?php Html::page_bread_crumb("/estoquemovimentos/estoque_view", $field_name, $field_value); ?>
                            ...
                            <table class="table table-hover table-striped table-sm text-left">
                                ...
                                <tbody class="page-data">
                                    ...
                                    <tr>
                                        ...
                                        <!--PageComponentStart-->
                                        <td class="td-id">
                                            <a href="<?php print_link("/estoquemovimentos/view/$data[id]") ?>"><?php echo $data['id']; ?></a>
                                        </td>
                                    ...
                                    <td class="td-tipo">
                                        ...
                                        data-url="<?php print_link("estoquemovimentos/edit/" . urlencode($data['id'])); ?>" 
                                        data-name="tipo" 
                        ...
                        <td class="td-btn">
                            <div class="dropdown" >
                                ...
                                <ul class="dropdown-menu">
                                    <?php if($can_view){ ?>
                                    <a class="dropdown-item "   href="<?php print_link("estoquemovimentos/view/$rec_id"); ?>" >
                                    <i class="material-icons">visibility</i> {{ __('view') }}
                                </a>
                                <?php } ?>
                                <?php if($can_edit){ ?>
                                <a class="dropdown-item "   href="<?php print_link("estoquemovimentos/edit/$rec_id"); ?>" >
                                <i class="material-icons">edit</i> {{ __('edit') }}
                            </a>
                            <?php } ?>
                            <?php if($can_delete){ ?>
                            <a class="dropdown-item record-delete-btn" data-prompt-msg="{{ __('promptDeleteRecord') }}" data-display-style="modal" href="<?php print_link("estoquemovimentos/delete/$rec_id"); ?>" >
...
<div class=" mt-3">
    <div class="row align-items-center justify-content-between">    
        <div class="col-md-auto d-flex">    
            <?php if($can_delete){ ?>
            <button data-prompt-msg="{{ __('promptDeleteRecords') }}" data-display-style="modal" data-url="<?php print_link("estoquemovimentos/delete/{sel_ids}"); ?>" class="btn btn-sm btn-danger btn-delete-selected d-none">
            ...
            <?php Html :: import_form('estoquemovimentos/importdata' , __('importData')); ?>
        </div>
        <div class="col">   
            <?php
