...
<?php
    ...
    $pageTitle = __('estoqueMovimentoDetails'); //set dynamic page title
?>
@extends($layout)
        ...
        <div class="container">
            <div class="row ">
                ...
                <div class="d-flex align-items-center gap-2">
                    ...
                    <?php if($can_edit){ ?>
                    <a class="btn btn-sm btn-success has-tooltip "   title="{{ __('edit') }}" href="<?php print_link("estoquemovimentos/edit/$rec_id"); ?>" >
                    <i class="material-icons">edit</i> {{ __('edit') }}
                </a>
                <?php } ?>
                <?php if($can_delete){ ?>
                <a class="btn btn-sm btn-danger has-tooltip record-delete-btn" data-prompt-msg="{{ __('promptDeleteRecord') }}" data-display-style="modal" title="{{ __('delete') }}" href="<?php print_link("estoquemovimentos/delete/$rec_id?redirect=estoquemovimentos"); ?>" >
