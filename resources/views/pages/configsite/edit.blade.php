...
<?php
    $pageTitle = __('editConfigSite'); //set dynamic page title
?>
@extends($layout)
            ...
            <div class="row ">
                <div class="col-md-9 comp-grid " >
                    <div  class="card card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("configsite/edit/$rec_id"); ?>" method="post">
                        <!--[form-content-start]-->
                        @csrf
                        <div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-nome_site-holder" class=" ">
                                            <textarea placeholder="{{ __('enterNomeSite') }}" id="ctrl-nome_site" data-field="nome_site"  required="" rows="5" name="nome_site" class="htmleditor form-control"><?php  echo $data['nome_site']; ?></textarea>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-endereco-holder" class=" ">
                                            <textarea placeholder="{{ __('enterEndereco') }}" id="ctrl-endereco" data-field="endereco"  rows="5" name="endereco" class="htmleditor form-control"><?php  echo $data['endereco']; ?></textarea>
                                            <!--<div class="invalid-feedback animated bounceIn text-center">{{ __('pleaseEnterText') }}</div>-->
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-telefone-holder" class=" ">
                                            <input id="ctrl-telefone" data-field="telefone"  value="<?php  echo $data['telefone']; ?>" type="tel" placeholder="{{ __('enterTelefone') }}"  name="telefone"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-whatsapp-holder" class=" ">
                                            <input id="ctrl-whatsapp" data-field="whatsapp"  value="<?php  echo $data['whatsapp']; ?>" type="text" placeholder="{{ __('enterWhatsapp') }}"  name="whatsapp"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-facebook-holder" class=" ">
                                            <input id="ctrl-facebook" data-field="facebook"  value="<?php  echo $data['facebook']; ?>" type="text" placeholder="{{ __('enterFacebook') }}"  name="facebook"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-instagram-holder" class=" ">
                                            <input id="ctrl-instagram" data-field="instagram"  value="<?php  echo $data['instagram']; ?>" type="text" placeholder="{{ __('enterInstagram') }}"  name="instagram"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-twitter-holder" class=" ">
                                            <input id="ctrl-twitter" data-field="twitter"  value="<?php  echo $data['twitter']; ?>" type="text" placeholder="{{ __('enterTwitter') }}"  name="twitter"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-linkedin-holder" class=" ">
                                            <input id="ctrl-linkedin" data-field="linkedin"  value="<?php  echo $data['linkedin']; ?>" type="text" placeholder="{{ __('enterLinkedin') }}"  name="linkedin"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-youtube-holder" class=" ">
                                            <input id="ctrl-youtube" data-field="youtube"  value="<?php  echo $data['youtube']; ?>" type="text" placeholder="{{ __('enterYoutube') }}"  name="youtube"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-horario_funcionamento-holder" class=" ">
                                            <input id="ctrl-horario_funcionamento" data-field="horario_funcionamento"  value="<?php  echo $data['horario_funcionamento']; ?>" type="text" placeholder="{{ __('enterHorarioFuncionamento') }}"  name="horario_funcionamento"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-sobre-holder" class=" ">
                                            <textarea placeholder="{{ __('enterSobre') }}" id="ctrl-sobre" data-field="sobre"  rows="5" name="sobre" class="htmleditor form-control"><?php  echo $data['sobre']; ?></textarea>
                                            <!--<div class="invalid-feedback animated bounceIn text-center">{{ __('pleaseEnterText') }}</div>-->
                                        </div>
                                    </div>
                                </div>
