...
<?php
    $pageTitle = __('addNewProduto'); //set dynamic page title
?>
@extends($layout)
            ...
            <div class="row ">
                <div class="col-md-9 comp-grid " >
                    <div  class="card card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form id="produtos-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="{{ route('produtos.store') }}" method="post">
                            @csrf
                            <div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-nome-holder" class=" ">
                                                <input id="ctrl-nome" data-field="nome"  value="<?php echo get_value('nome') ?>" type="text" placeholder="{{ __('enterNome') }}"  required="" name="nome"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-descricao-holder" class=" ">
                                                <textarea placeholder="{{ __('enterDescricao') }}" id="ctrl-descricao" data-field="descricao"  rows="5" name="descricao" class=" form-control"><?php echo get_value('descricao') ?></textarea>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-preco-holder" class=" ">
                                                <input id="ctrl-preco" data-field="preco"  value="<?php echo get_value('preco', "0.00") ?>" type="number" placeholder="{{ __('enterPreco') }}" step="0.1"  required="" name="preco"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-quantidade-holder" class=" ">
                                                <input id="ctrl-quantidade" data-field="quantidade"  value="<?php echo get_value('quantidade', "0") ?>" type="number" placeholder="{{ __('enterQuantidade') }}" step="any"  name="quantidade"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
