...
<?php
    $pageTitle = __('editEstoqueEntrada'); //set dynamic page title
?>
@extends($layout)
            ...
            <div class="row ">
                <div class="col-md-9 comp-grid " >
                    <div  class="card card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("estoqueentradas/edit/$rec_id"); ?>" method="post">
                        <!--[form-content-start]-->
                        @csrf
                        <div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-valor_unitario-holder" class=" ">
                                            <input id="ctrl-valor_unitario" data-field="valor_unitario"  value="<?php  echo $data['valor_unitario']; ?>" type="number" placeholder="{{ __('enterValorUnitario') }}" step="0.1"  name="valor_unitario"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
